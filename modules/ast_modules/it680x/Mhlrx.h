...
#undef _ENABLE_IT68XX_MHL_FUNCTION_

#ifdef _ENABLE_IT68XX_MHL_FUNCTION_
#define _SUPPORT_RCP_						// for support it6811 and it6802 MHL CBUS
#define _SUPPORT_RAP_						// for support it6811 and it6802 MHL CBUS
//#define _SUPPORT_UCP_						// for support it6811 and it6802 MHL CBUS
#else
#undef _SUPPORT_RCP_
#undef _SUPPORT_RAP_
//#undef _SUPPORT_UCP_						// for support it6811 and it6802 MHL CBUS
#endif
//FIX_ID_036	xxxxx
...
#define _SUPPORT_EDID_RAM_		FALSE

//FIX_ID_001 xxxxx Add Auto EQ with Manual EQ
#define _SUPPORT_AUTO_EQ_                        TRUE
#define _SUPPORT_EQ_ADJUST_                     TRUE             // Must always on !!!
//FIX_ID_001 xxxxx
...
typedef struct _xxxIT680XCallbackList_t
{
...
} IT680XCallbackList_t, *pIT680XCallbackList_t;
//FIX_ID_032 xxxxx
#endif
...
{
#if (AST_HDMIRX)
	void *d; //Linux driver context
	VTiming *CurVTiming;
	unsigned int AviPicAsRatio;
	unsigned int GCPColorDepth;
	AVI_InfoFrame avi_info_shadow;
	hdr_infoframe hdr_info_shadow; /* dynamic range and mastering infoframe */
	unsigned int last_hdcp_status; /* -1: not queried yet. true: enable 1.x, false: disable */
	unsigned int hdmi_n;
...
#if (AST_HDMIRX)
	unsigned char m_NewHDRInfoFrameF:1;
#endif
...
void IT680x_RxHDCP2ndAuthenticationRequest(unsigned char *pKsvList, unsigned char *pBksv, unsigned int Tx_Bstatus);
