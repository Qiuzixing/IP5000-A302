  ...
  <div class="main-setting">
    <div class="setting-model" style="margin-bottom: 0">
      ...
      <div class="setting" style="margin-top: 25px;">
        ...
        <multiselect :disabled="audioMode.val != '0'" v-model="audioSource.val"
...
export default {
  ...
  data () {
    return {
      ...
      listMap: {
        ...
        'in.analog.1.audio': 'Analog'
      },
      lists: ['in.hdmi.1.audio', 'in.analog.1.audio'],
      avSignal: {
  ...
  created () {
    ...
    this.$socket.sendMsg('#X-AV-SW-MODE? out.hdmi.1.audio.2')
  ...
  methods: {
    ...
    save () {
      ...
      this.$socket.sendMsg(`#X-AV-SW-MODE out.hdmi.1.audio.2,${this.audioMode.val}`)
