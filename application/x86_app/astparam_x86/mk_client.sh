...
./astparam w ipaddr 192.168.0.50
./astparam w serverip 192.168.0.116
./astparam w stdin serial
./astparam w stdout serial
./astparam w stderr serial
./astparam w eth1addr 00:C0:A8:12:34:57
./astparam w ethaddr 00:15:25:08:01:11
./astparam w bootfile \"allc.bin\"
...
cd ${ROOT_DIR}
dd if=${IMAGE_DIR}/mtdblkroparam of=allc.bin bs=64k seek=255 count=1 conv=notrunc
