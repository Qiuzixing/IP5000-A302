...
config:
	./configure --host=arm-linux --build=i686-linux --prefix=$(PREFIX) CC=$(CROSS_COMPILE)gcc RANLIB=$(CROSS_COMPILE)ranlib LD=$(CROSS_COMPILE)ld CXX=$(CROSS_COMPILE)g++
...
install:
	...
	@cp -af $(PREFIX)/lib/libexpat* $(ROOTFS)/lib
