...
#define USB_CLASS_AUDIO_VIDEO		0x10	/* Audio/Video Device */
#define USB_CLASS_DIAGNOSTIC		0xdc	/* Diagnostic Device */
...
struct _config {
	...
	struct kmoip_entry *kmoip_ports;
};
