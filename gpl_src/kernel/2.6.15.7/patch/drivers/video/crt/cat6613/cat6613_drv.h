...
#endif
#define I2C_CAT6613_SPEED 100000
...
#define REG_TX_INT_CTRL 0x05
    ...
    #define M_LOW_SPD_DDC_EN (1<<1)
    #define B_LOW_SPD_DDC_EN   (1<<1)
    #define O_DDC_SPD (2)
    #define M_DDC_SPD (0x3<<O_DDC_SPD)
    #define B_DDC_SPD_0 (0<<O_DDC_SPD) // 77KHz/2
    #define B_DDC_SPD_1 (1<<O_DDC_SPD) //77KHz/4
...
#define REG_TX_HDES_L 0x92
#define REG_TX_HDEE_L 0x93
#define REG_TX_HDE_H 0x94
#define REG_TX_HSSL 0x95
#define REG_TX_HSEL 0x96
#define REG_TX_HSH 0x97
#define REG_TX_VTOTAL_L 0x98
#define REG_TX_VTOTAL_H 0x99
#define REG_TX_VDES_L 0x9A
#define REG_TX_VDEE_L 0x9B
#define REG_TX_VDE_H 0x9C
#define REG_TX_VDES2_L 0x9D
#define REG_TX_VDEE2_L 0x9E
#define REG_TX_VDE2_H 0x9F
...
//	HDMI_Aspec aspec;
	...
	//Antony, to solve i2s channel issues
#if 0//steven
...
typedef struct _INSTANCE_STRUCT {
	...
	// Interrupt Type
	/////////////////////////////////////////////////
	BYTE bIntType ; // = 0 ; //steven???
	/////////////////////////////////////////////////
	// Video Property
	/////////////////////////////////////////////////
	BYTE bInputVideoSignalType ; // for Sync Embedded,CCIR656,InputDDR //steven???
	/////////////////////////////////////////////////
	// Audio Property
	/////////////////////////////////////////////////
    ...
    BYTE HDMISink;
	BYTE SinkEDID[256];
	unsigned int EDIDisReady;
#if SUPPORT_HDCP_REPEATER
	unsigned char	Hdcp_mode;//0:transmitter; 1:repeater
	unsigned char	Hdcp_encrypt;//0:disable; 1:enable
	unsigned char	Bksv[5];
	unsigned char	Bcaps;
	unsigned short	Bstatus;
	unsigned char	KSVList[150];//5 * 30
#endif
#endif
} INSTANCE ;
...
#if defined(CODE202)
BOOL EnableVendorSpecificInfoFrame(BYTE bEnable, BYTE *pInfoFrame);
#endif
