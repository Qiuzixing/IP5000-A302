...
/*
 *****************************************************************************
 * @file  i2c_slave_addrs.h
 *
 * @brief Definitions of the i2c slave addresses.
 *
 *****************************************************************************
*/
...
typedef enum
{
	...
	,SA_RX_Page0_Primary							= 0x60, SA_TX_Ekki_Page_0 = SA_RX_Page0_Primary
	...
	,SA_TX_CBUS_Primary								= 0xC8 , SA_RX_COLOR_Primary 	= SA_TX_CBUS_Primary
	...
	,SA_RX_CEC_ASSIGNED								= 0xF0
}SiI_I2C_Default_SlaveAddresses_e;

#define ENCODE_PAGE_LOOKUP(slave_addr,offset) ((slave_addr << 8) | offset)
