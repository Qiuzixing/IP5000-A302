 ...
 *
 * @brief Configurations for the sii9136_300 specific library.
 *
 ******************************************************************************/
...
#define IS_HEC                  0       // Set to 1 to enable HEC support
#define IS_CBUS                 0       // Set to 1 to enable MHL CBUS support
...
#define MHL_MAX_CHANNELS                2   // Number of MDHI channels
