...
void vSetChrontel(struct astfb_info *dinfo, USHORT usWhichOne);
...
{        
    ...
    /* Move I2C Setting to init to avoid the conflict to I2C Driver */
    vSetChrontel(dinfo, CRT1);
...
astfb_blank_var(int blank, struct astfb_info *dinfo)
{
   ...
   default:
    ...
    if (usWhichOne == CRT2 )
    {
        ulCrtlRegIndex =  AST3000_VGA2_CTLREG;
    }
    else
    {
        ulCrtlRegIndex =  AST3000_VGA1_CTLREG;
    }
...
#define I2C_VA_BASE	IO_ADDRESS(ASPEED_I2C_BASE)
#define I2C_OFFSET1	(0x40 * 3)
#define I2C_DEVICEADDR1	0x0EA
#define I2C_OFFSET2	(0x40 * 3)
#define I2C_DEVICEADDR2	0x0EC
#endif
