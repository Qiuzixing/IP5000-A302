#ifndef _AST1500_BOARD_DEF_1510_V5_H
#define	_AST1500_BOARD_DEF_1510_V5_H
...
#define GPIO_CH_UPDATE	AST1500_GPC0
	#define GPIO_CH_UPDATE_ACTIVE	0
#define GPIO_POWER_CTRL_IN		AST1500_GPC1//client
#define GPIO_POWER_CTRL_OUT		AST1500_GPC1//host
#define GPIO_POWER_STATUS_OUT	AST1500_GPA1 //For remote PC pwr status (Client)
#define GPIO_POWER_STATUS_IN		AST1500_GPA1 //For remote PC pwr status (Host)
...
#endif
#define GPIO_AUDIO_CODEC_IN_HOTPLUG AST1500_GPC3
#define GPIO_AUDIO_CODEC_IN_HOTPLUG_ACTIVE 1 /* 0:low active, 1:high active */
#define GPIO_AUDIO_CODEC_OUT_HOTPLUG AST1500_GPC2
#define GPIO_AUDIO_IO_SELECT AST1500_GPJ6
#define GPIO_AUDIO_CODEC_RESET AST1500_GPJ7
#define GPIO_IR_DISABLE AST1500_GPP6
#define GPIO_IR_IO_SWITCH AST1500_GPP6
#define GPIO_HOST_DAC_SWITCH AST1500_GPJ5
	#define GPIO_HOST_DAC_SWITCH_ON 1
	#define GPIO_HOST_DAC_SWITCH_OFF 0
	

#endif //#ifndef _AST1500_BOARD_DEF_1510_V5_H
