#ifndef _AST1500_BOARD_DEF_1520_V1_H
#define	_AST1500_BOARD_DEF_1520_V1_H
...
//client VGA DDC
#define I2C_CLIENT_VIDEO_DDC_EEPROM 14
...
#define GPIO_POWER_CTRL_IN		AST1500_GPJ6//client
#define GPIO_POWER_CTRL_OUT		AST1500_GPJ6//host
#define GPIO_POWER_STATUS_OUT	AST1500_GPL0 //For remote PC pwr status (Client)
#define GPIO_POWER_STATUS_IN		AST1500_GPY2 //For remote PC pwr status (Host)
...
#define	GPIO_HOST_VIDEO_DDC_PATH_CONTROL	AST1500_GPK6
...
#define GPIO_CAT6023_RST AST1500_GPD3 //ToCheck. is low active
#define GPIO_CAT6023_INT AST1500_GPD6 //ToCheck. is low active
#define GPIO_CAT6613_RST AST1500_GPD1 //ToCehck. is low active
#ifdef FPGA_TEST_ONLY
	#define GPIO_CAT6613_INT AST1500_GPD4
#else
	#define GPIO_CAT6613_INT AST1500_GPD2 //ToCheck. is low active
#endif
...
#define GPIO_AUDIO_CODEC_RESET AST1500_GPD7 //ToCheck. is low active
...
#endif //#ifndef _AST1500_BOARD_DEF_1520_V1_H
