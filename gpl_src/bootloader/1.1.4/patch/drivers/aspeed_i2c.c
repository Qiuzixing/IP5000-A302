 ...
 * Basic I2C functions
 *
 * Copyright (c) 2006 ASPEED TECHNOLOGY
 *
 ...
 *
 * Author: River Huang river_huang@aspeedtech.com, ASPEED TECHNOLOGY
 *
 */
...
//I2C Multi-Pin
        ...
        outl ((SCURegister | 0x20000), SCU_BASE + SCU_MULTIFUNCTION_PIN_CTL5_REG);
#endif
//Reset
