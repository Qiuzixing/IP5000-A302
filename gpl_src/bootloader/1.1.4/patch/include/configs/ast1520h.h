...
#define CONFIG_AST1500_SOC_VER		3 //1:AST1500, 2:AST1510, 3:AST1520
#define CONFIG_AST_FPGA_VER			0 //0:Not FPGA, 1:AST3000 2:AST2300 3:AST2400 4:AST1520(ARM11)

//#define CONFIG_CPU_600 1
//#define CONFIG_CPU_792 1
#define CONFIG_CPU_912 1
//#define CONFIG_CPU_1008 1
//#define CONFIG_CPU_1056 1
...
#define CONFIG_DDRINI_CHECK         /* Skip DRAM init under software reset. Don't enable it in production code. */
...
#define CONFIG_COMMANDS		((CONFIG_CMD_DFL  | CFG_CMD_NET) | CFG_CMD_ENV | CFG_CMD_FLASH | CFG_CMD_PING | CONFIG_CMD_ETHACT | CFG_CMD_I2C | CFG_CMD_EEPROM) & ~CFG_CMD_PCMCIA
...
#else //For 32MB flash. Will only use 16MB, but the value of CFG_MAX_FLASH_SECT must be correct, otherwise the flash driver will get confused.
#define CFG_MAX_FLASH_BANKS 	1
...
#define CFG_MEMTEST_END		0x84FFFFFF	/* 256 MB in DRAM	*/

#define	CFG_CLKS_IN_HZ		/* everything, incl board info, in Hz */
#undef	CFG_CLKS_IN_HZ		/* everything, incl board info, in Hz */

#define CFG_LOAD_ADDR		0x83000000	/* default load address */
