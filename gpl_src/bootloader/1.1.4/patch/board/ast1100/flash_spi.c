...
#define SST25VF016B             0x2541bf
#define SST25VF064C             0x4b25bf

/* SPI Define */
#if defined(CONFIG_AST1160)
#ifndef CFG_STMREG_BASE
#define CFG_STMREG_BASE		0x00fcc200
#endif

#define STCBaseAddress		CFG_STMREG_BASE
#define SPICtrlRegOffset	0x04
#define SPICtrlRegOffset2	0x08
...
#if defined(CONFIG_AST1160)
	if (info->size > 0x200000)	/* limit MAX Flash to 2MB for AST1160 */
	    info->size = 0x200000;
	cpuclk = CFG_CLK / 1000000;    
#else	/* AST2100 */        
