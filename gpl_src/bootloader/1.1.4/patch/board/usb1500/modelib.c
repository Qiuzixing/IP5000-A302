...
BOOL bGetASTVGAModeInfo(_ModeInfo *ModeInfo, PVBIOS_MODE_INFO pVGAModeInfo, _LCDInfo *LCDInfo, USHORT usWhichOne)
{
...
void vSetASTCRTCReg( _ModeInfo *ModeInfo, PVBIOS_MODE_INFO pVGAModeInfo, USHORT usWhichOne)
{
    ...
    if (usWhichOne == CRT2 )
    {
        HTIndex =  AST1500_VGA2_HTREG;
        HRIndex =  AST1500_VGA2_HRREG;  
        VTIndex =  AST1500_VGA2_VTREG;
        VRIndex =  AST1500_VGA2_VRREG;               
    }
    else
    {
        HTIndex =  AST1500_VGA1_HTREG;
        HRIndex =  AST1500_VGA1_HRREG;
        VTIndex =  AST1500_VGA1_VTREG;
        VRIndex =  AST1500_VGA1_VRREG;          
    }    
    ...
    /* Write Reg */
    *(unsigned long *) (AST1500_VGAREG_BASE + HTIndex) = (ULONG)(HDE2 << 16) | (ULONG) (HT2);
    *(unsigned long *) (AST1500_VGAREG_BASE + HRIndex) = (ULONG)(HRE2 << 16) | (ULONG) (HRS2);
    *(unsigned long *) (AST1500_VGAREG_BASE + VTIndex) = (ULONG)(VDE2 << 16) | (ULONG) (VT2);
    *(unsigned long *) (AST1500_VGAREG_BASE + VRIndex) = (ULONG)(VRE2 << 16) | (ULONG) (VRS2);
                          	
}

void vSetASTOffsetReg(  _ModeInfo *ModeInfo, PVBIOS_MODE_INFO pVGAModeInfo, USHORT usWhichOne)
{
    ...
    if (usWhichOne == CRT2 )
    {
        ulOffsetIndex =  AST1500_VGA2_OFFSETREG;
    }
    else
    {
        ulOffsetIndex =  AST1500_VGA1_OFFSETREG;
    }    
    ...
    /* Write Reg */
    *(unsigned long *) (AST1500_VGAREG_BASE + ulOffsetIndex) = (ULONG) (usTermalCount << 16) | (ULONG) (usOffset);

}

void vSetASTDCLKReg( _ModeInfo *ModeInfo, PVBIOS_MODE_INFO pVGAModeInfo, USHORT usWhichOne)
{
    ...
    pEnhModePtr = pVGAModeInfo->pEnhTableEntry;
    pDCLKPtr = &ASTDCLKTable[pEnhModePtr->DCLKIndex];

    /* Reg. Index Select */
    if (usWhichOne == CRT2 )
    {
        ulPLLIndex =  AST1500_VGA2_PLL;
    }
    else
    {
        ulPLLIndex =  AST1500_VGA1_PLL;      	
    }
        
    /* Write Reg */
    *(unsigned long *) (AST1500_VGAREG_BASE + ulPLLIndex) = *(ULONG *) pDCLKPtr;
    
}


void vSetASTExtReg( _ModeInfo *ModeInfo, PVBIOS_MODE_INFO pVGAModeInfo, _LCDInfo *LCDInfo, USHORT usWhichOne, ULONG ulFBBase)
{
    ULONG ulCtlRegIndex, ulCtlReg = 0x01;		/* enable display */
    ULONG ulCtlReg2Index, ulCtlReg2 = 0x81;    
    ...
    case LVDS2:
        ...
        ulCtlReg2Index =  AST1500_VGA2_CTLREG2;        
        ulThresholdRegIndex = AST1500_VGA2_THRESHOLD;
        ulStartAddressIndex =  AST1500_VGA2_STARTADDR;
...
*/            
    ...
    case LVDS1:    
        ...
        ulCtlReg2Index =  AST1500_VGA1_CTLREG2;                
        ulThresholdRegIndex = AST1500_VGA1_THRESHOLD;
        ulStartAddressIndex =  AST1500_VGA1_STARTADDR;
        ulStartAddress = ulFBBase;
    ...
    /* Write Reg */
    *(unsigned long *) (AST1500_VGAREG_BASE + ulStartAddressIndex) = ulStartAddress;
    *(unsigned long *) (AST1500_VGAREG_BASE + ulThresholdRegIndex) = ((ULONG) CRT_HIGH_THRESHOLD_VALUE << 8) | (ULONG) (CRT_LOW_THRESHOLD_VALUE);
    *(unsigned long *) (AST1500_VGAREG_BASE + ulCtlRegIndex) = ulCtlReg;
    *(unsigned long *) (AST1500_VGAREG_BASE + ulCtlReg2Index) = ulCtlReg2;
...
void vSetScaleFactor( _ModeInfo *ModeInfo, _LCDInfo *LCDInfo)
{
    ...
    /* set Reg */
    *(unsigned long *) (AST1500_VGAREG_BASE + 0x8C) = (((ULONG) FactorY & 0xFFFF) << 16) | ((ULONG) (FactorX) & 0xFFFF);
    ...
    for (i=0; i<2; i++)
    {
        ...
        *(unsigned long *) (AST1500_VGAREG_BASE + 0xc0 + i*4) = ulData;
    ...
    for (i=0; i<2; i++)
    {
        ...
        *(unsigned long *) (AST1500_VGAREG_BASE + 0xc8 + i*4) = ulData;
...
/* AST1500 Procedure */
BOOL _ASTSetMode(_ModeInfo *ModeInfo, _LCDInfo *LCDInfo, USHORT usWhichOne, ULONG ulFBBase)
{
    VBIOS_MODE_INFO vgamodeinfo; 
		
    /* pre set mode */        		
    bGetASTVGAModeInfo(ModeInfo, &vgamodeinfo, LCDInfo, usWhichOne & 0x01);  
      
    /* set mode */
    vSetASTCRTCReg( ModeInfo, &vgamodeinfo, usWhichOne & 0x01);
    vSetASTOffsetReg( ModeInfo, &vgamodeinfo, usWhichOne & 0x01);    
    vSetASTDCLKReg( ModeInfo, &vgamodeinfo, usWhichOne & 0x01);
/*    
    if (LCDInfo->EnableScaling && (usWhichOne & 0x01))
        vSetScaleFactor( ModeInfo, LCDInfo);
*/        
    vSetASTExtReg( ModeInfo, &vgamodeinfo, LCDInfo, usWhichOne, ulFBBase);
...
{
    _ASTSetMode(ModeInfo, LCDInfo, usWhichOne, ulFBBase);    
...
void vInitASTSCURegForCRT(void)
{
    ...
    *(unsigned long *) (0x1e6e2000 + 0x74) = ulData;         
    ...
    /* Set Single Edge */
    ulData = *(unsigned long *)(0x1e6e2000 + 0x78);
    ulData |= 0x03;
    *(unsigned long *) (0x1e6e2000 + 0x78) = ulData;         
...
unsigned long bGetCRC(USHORT usWhichOne)
{
    ...
    {
        ulCtlRegIndex2   =  AST1500_VGA1_CTLREG2;
        ulStatusRegIndex =  AST1500_VGA1_STATUSREG;
    ...
    /* Trigger CRC */
    *(unsigned long *) (AST1500_VGAREG_BASE + ulCtlRegIndex2) |= 0x04;
    do {
        ulData = *(volatile unsigned long *) (AST1500_VGAREG_BASE + ulCtlRegIndex2);    	
    } while (ulData & 0x08);
    udelay(1000*1000);	
    ulCRC = *(unsigned long *) (AST1500_VGAREG_BASE + ulStatusRegIndex) & 0xFFFFFF00;
    
    /* Disable CRC */
    *(unsigned long *) (AST1500_VGAREG_BASE + ulCtlRegIndex2) &= 0xFFFFFFFB;
