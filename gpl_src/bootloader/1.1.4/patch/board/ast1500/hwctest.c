...
BOOL bShowHWC(_HWCInfo *HWCInfo, USHORT usWhichOne, ULONG ulHWC_OFFSET)
{
    ...
    if (usWhichOne == CRT2 )
    {
        ...
        ulHWCOffsetReg = AST1500_HWC2_OFFSET;
        ulHWCXYReg     = AST1500_HWC2_XY;
        ulPatternReg   = AST1500_HWC2_PBase; 	
    }
    else
    {
        ulCtlRegIndex  = AST1500_VGA1_CTLREG;
        ulHWCOffsetReg = AST1500_HWC1_OFFSET;
        ulHWCXYReg     = AST1500_HWC1_XY;
        ulPatternReg   = AST1500_HWC1_PBase;          	
    }    
    ...
    /* Enable HWC */
    *(unsigned long *) (AST1500_VGAREG_BASE + ulHWCOffsetReg) = ulOffset;
    *(unsigned long *) (AST1500_VGAREG_BASE + ulHWCXYReg) = ulXY;
    *(unsigned long *) (AST1500_VGAREG_BASE + ulPatternReg) = ulHWC_OFFSET;
