...
#endif
#ifdef CONFIG_AST2000
#define READ_TIMER (*(volatile ulong *)(CFG_TIMERBASE+4))
#endif
#ifdef CONFIG_AST2100
#define READ_TIMER (*(volatile ulong *)(CFG_TIMERBASE+0))
#endif
#ifdef CONFIG_AST3000
#define READ_TIMER (*(volatile ulong *)(CFG_TIMERBASE+0))
#endif
#ifdef CONFIG_AST1500
#define READ_TIMER (*(volatile ulong *)(CFG_TIMERBASE+0))
#endif
#ifdef CONFIG_AST1100
#define READ_TIMER (*(volatile ulong *)(CFG_TIMERBASE+0))
#endif
...
int interrupt_init (void)
{
	...
	*(volatile ulong *)(CFG_TIMERBASE + 8) = 0x18a;
#endif  /* CONFIG_AST2000 */
#ifdef CONFIG_AST2100
	*(volatile ulong *)(CFG_TIMERBASE + 4)    = TIMER_LOAD_VAL;
	*(volatile ulong *)(CFG_TIMERBASE + 0x30) = 0x3;		/* enable timer1 */
#endif  /* CONFIG_AST2100 */
#ifdef CONFIG_AST3000
	*(volatile ulong *)(CFG_TIMERBASE + 4)    = TIMER_LOAD_VAL;
	*(volatile ulong *)(CFG_TIMERBASE + 0x30) = 0x3;		/* enable timer1 */
#endif  /* CONFIG_AST3000 */
#ifdef CONFIG_AST1500
	*(volatile ulong *)(CFG_TIMERBASE + 4)    = TIMER_LOAD_VAL;
	*(volatile ulong *)(CFG_TIMERBASE + 0x30) = 0x3;		/* enable timer1 */
#endif  /* CONFIG_AST1500 */
#ifdef CONFIG_AST1100
	*(volatile ulong *)(CFG_TIMERBASE + 4)    = TIMER_LOAD_VAL;
	*(volatile ulong *)(CFG_TIMERBASE + 0x30) = 0x3;		/* enable timer1 */
#endif  /* CONFIG_AST1100 */
